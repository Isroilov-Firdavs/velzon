            ...
            <div class="card">
                <div class="card-header align-items-center d-flex">
                    <div class="flex-grow-1">
                        <h4 class="card-title mb-0" Highlight</h4>
                    </div>
                </div><!-- end card header -->

                <div class="card-body">
                    <p class="text-muted" highlight is used to mark or highlight text that is of property, relevance, or special interest to an document. here is the example shown below.</p>

                    <div class="live-preview">
                        <pre>
<code class="language-markup">&lt;!DOCTYPE&gt;
&lt&gt;
&lt;head&gt;
