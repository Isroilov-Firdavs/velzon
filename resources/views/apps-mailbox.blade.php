        ...
        <div class="p-4 d-flex flex-column h-100">
            ...
            <div class="mx-n4 px-4 email-menu-sidebar-scroll" data-simplebar>
                <div class="mail-list mt-3">
                    <a href="#" class="active"><i class="ri-inbox-archive-fill me-3 align-middle fw-medium"></i> Inbox <span class="badge badge-soft-success ms-auto  ">5</span></a>
                ...
                <div>
                    ...
                    <div class="mail-list mt-1">
                        <a href="#"><span class="ri-checkbox-blank-circle-line me-2 text-info"></span> Theme Support <span class="badge badge-soft-success ms-auto">3</span></a>
                        <a href="#"><span class="ri-checkbox-blank-circle-line me-2 text-warning"></span> Freelance</a>
                        <a href="#"><span class="ri-checkbox-blank-circle-line me-2 text-primary"></span> Social</a>
                        <a href="#"><span class="ri-checkbox-blank-circle-line me-2 text-danger"></span> Friends<span class="badge badge-soft-success ms-auto">2</span></a>
                        <a href="#"><span class="ri-checkbox-blank-circle-line me-2 text-success"></span> Family</a>
                    </div>
                </div>

                <div class="border-top border-top-dashed pt-3 mt-3">
                    <a href="#" class="btn btn-icon btn-sm btn-soft-info btn-rounded float-end shadow-none"><i class="bx bx-plus fs-16"></i></a>
                ...
                <div class="row mt-n2 mb-3 mb-sm-0">
                    ...
                    <div class="col-sm order-3 order-sm-2">
                        <div class="hstack gap-sm-1 align-items-center flex-wrap email-topbar-link">
                            ...
                            <button type="button" class="btn btn-ghost-secondary shadow-none btn-icon btn-sm fs-16" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-placement="top" title="Archive">
                                <i class="ri-inbox-archive-fill align-bottom"></i>
                            </button>
                            <button type="button" class="btn btn-ghost-secondary shadow-none btn-icon btn-sm fs-16" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-placement="top" title="Report Spam">
                                <i class="ri-error-warning-fill align-bottom"></i>
                            </button>
                            <button type="button" class="btn btn-ghost-secondary shadow-none btn-icon btn-sm fs-16" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-placement="top" title="Trash">
                                <i class="ri-delete-bin-5-fill align-bottom"></i>
                            </button>
                            <div class="vr align-self-center mx-2"></div>
                            <button type="button" class="btn btn-ghost-secondary shadow-none btn-icon btn-sm fs-16" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-placement="top" title="Labels">
                    ...
                    <div class="col-auto order-2 order-sm-3">
                        <div class="d-flex gap-sm-1 email-topbar-link">
                            <button type="button" class="btn btn-ghost-secondary shadow-none btn-icon btn-sm fs-16">
                ...
                <ul class="message-list">
                    <li>
                        <div class="col-mail col-mail-1">
                            ...
                            <button type="button" class="btn avatar-xs p-0 favourite-btn shadow-none fs-15 active">
                    ...
                    <li>
                        <div class="col-mail col-mail-1">
                            ...
                            <button type="button" class="btn avatar-xs p-0 favourite-btn shadow-none fs-15">
                                <i class="ri-star-fill"></i>
                            </button>
                    ...
                    <li>
                        <div class="col-mail col-mail-1">
                            ...
                            <button type="button" class="btn avatar-xs p-0 favourite-btn shadow-none active fs-15">
                                <i class="ri-star-fill"></i>
                            </button>
                    ...
                    <li class="bg-transparent text-center">
                        <button type="button" class="btn btn-soft-info btn-rounded btn-sm px-2 shadow-none"><i class="mdi mdi-spin mdi-loading me-2"></i>Load More</button>
                    </li>
        ...
        <div class="p-4 d-flex flex-column h-100">
            <div class="pb-4 border-bottom border-bottom-dashed">
                <div class="row">
                    ...
                    <div class="col-auto">
                        <div class="hstack gap-sm-1 align-items-center flex-wrap email-topbar-link">
                            <button type="button" class="btn btn-ghost-secondary btn-icon btn-sm fs-16 favourite-btn shadow-none active">
                                <i class="ri-star-fill align-bottom"></i>
                            </button>
                            <button class="btn btn-ghost-secondary btn-icon btn-sm fs-16 shadow-none">
                            ...
                            <div class="dropdown">
                                <button class="btn btn-ghost-secondary btn-icon btn-sm fs-16 shadow-none" type="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                    <i class="ri-more-2-fill align-bottom"></i>
                                </button>
                                <div class="dropdown-menu dropdown-menu-end">
                                    <a class="dropdown-item" href="#">Mark as Unread</a>
        ...
        <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
            <div class="modal-content">
                    ...
                    <div>
                        <div class="mb-3 position-relative">
                            ...
                            <div class="position-absolute top-0 end-0">
                                <div class="d-flex">
                                    <button class="btn btn-link text-reset fw-semibold px-2 shadow-none" type="button" data-bs-toggle="collapse" data-bs-target="#CcRecipientsCollapse" aria-expanded="false" aria-controls="CcRecipientsCollapse">
                                        Cc
                                    </button>
                                    <button class="btn btn-link text-reset fw-semibold px-2 shadow-none" type="button" data-bs-toggle="collapse" data-bs-target="#BccRecipientsCollapse" aria-expanded="false" aria-controls="BccRecipientsCollapse">
                                        Bcc
                                    </button>
                                </div>
                            </div>
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-ghost-danger shadow-none" data-bs-dismiss="modal">Discard</button>
