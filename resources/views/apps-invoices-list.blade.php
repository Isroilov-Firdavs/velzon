                            ...
                            <table class="table align-middle table-nowrap" id="invoiceTable">
                                ...
                                <tbody class="list form-check-all">
                                    <tr >
                                        ...
                                        <td class="id"><a href="apps-invoices-details" class="fw-medium link-primary">#VL25000351</a></td>
                                        <td class="customer_name">
                                            <div class="d-flex align-items-center">
                                                <img src="{{ URL::asset('assets/images/users/avatar-2.jpg') }}" alt="" class="avatar-xs rounded-circle me-2 shadow" />
                                                Diana Kohler
                                            </div>
                                        </td>
                                        ...
                                        <td>
                                            <div class="dropdown">
                                                ...
                                                <ul class="dropdown-menu dropdown-menu-end">
                                                    <li><a class="dropdown-item" href="apps-invoices-details"><i class="ri-eye-fill align-bottom me-2 text-muted"></i> View</a></li>
                                                    <li><a class="dropdown-item" href="apps-invoices-create"><i class="ri-pencil-fill align-bottom me-2 text-muted"></i> Edit</a></li>
                                    ...
                                    <tr>
                                        ...
                                        <td class="customer_name">
                                            <div class="d-flex align-items-center">
                                                <img src="{{ URL::asset('assets/images/users/avatar-3.jpg') }}" alt="" class="avatar-xs rounded-circle me-2 shadow" />
                                                James Morris
                                            </div>
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td class="customer_name">
                                            <div class="d-flex align-items-center">
                                                <img src="{{ URL::asset('assets/images/users/avatar-4.jpg') }}" alt="" class="avatar-xs rounded-circle me-2 shadow" />
                                                Dawn Koh
                                            </div>
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td class="customer_name">
                                            <div class="d-flex align-items-center">
                                                <img src="{{ URL::asset('assets/images/users/avatar-5.jpg') }}" alt="" class="avatar-xs rounded-circle me-2 shadow" />
                                                Tonya Noble
                                            </div>
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td class="customer_name">
                                            <div class="d-flex align-items-center">
                                                <img src="{{ URL::asset('assets/images/users/avatar-6.jpg') }}" alt="" class="avatar-xs rounded-circle me-2 shadow" />
                                                David Nichols
                                            </div>
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td class="customer_name">
                                            <div class="d-flex align-items-center">
                                                <img src="{{ URL::asset('assets/images/users/avatar-7.jpg') }}" alt="" class="avatar-xs rounded-circle me-2 shadow" />
                                                Joseph Payten
                                            </div>
                                        </td>
                                        ...
                                        <td class="customer_name">
                                            <div class="d-flex align-items-center">
                                                <div class="flex-shrink-0 avatar-xs me-2">
                                                    <div class="avatar-title bg-soft-success text-success rounded-circle fs-13 shadow">
                                                        MR
                                                    </div>
                                                </div>
                                                Mary Rucker
                                    ...
                                    <tr>
                                        ...
                                        <td class="customer_name">
                                            <div class="d-flex align-items-center">
                                                <img src="{{ URL::asset('assets/images/users/avatar-8.jpg') }}" alt="" class="avatar-xs rounded-circle me-2 shadow" />
                                                Ryan Cowie
                                            </div>
                                        </td>
