            ...
            <div class="collapse show" id="leadDiscovered">
                <div class="card mb-1">
                    ...
                    <div class="collapse border-top border-top-dashed" id="leadDiscovered1">
                        <div class="card-body">
                            <h6 class="fs-14 mb-1">Nesta Technologies <small
                                    class="badge badge-soft-danger">4 Days</small></h6>
                        ...
                        <div class="card-footer hstack gap-2">
                            <button class="btn btn-warning btn-sm w-100"><i
                                    class="ri-phone-line align-bottom me-1"></i> Call</button>
            ...
            <div class="collapse show" id="contactInitiated">
                ...
                <div class="card mb-1">
                    <div class="card-body">
                        <a class="d-flex align-items-center" data-bs-toggle="collapse"
                            ...
                            <div class="flex-shrink-0">
                                <img src="{{ URL::asset('assets/images/brands/github.png') }}" alt=""
                                    class="avatar-xs rounded-circle shadow" />
                            </div>
                            <div class="flex-grow-1 ms-3">
                    ...
                    <div class="collapse border-top border-top-dashed" id="contactInitiated2">
                        <div class="card-body">
                            <h6 class="fs-14 mb-1">Zoetic Fashion <small
                                    class="badge badge-soft-warning">25 Days</small></h6>
                            <p class="text-muted">As a company grows however, you find it's not as easy
                                to shout across</p>
                            <ul class="list-unstyled vstack gap-2 mb-0">
                                <li>
                ...
                <div class="card mb-1">
                    ...
                    <div class="collapse border-top border-top-dashed" id="contactInitiated3">
                        <div class="card-body">
                            <h6 class="fs-14 mb-1">Micro Design <small
                                    class="badge badge-soft-success">2 Month</small></h6>
                            <p class="text-muted">As a company grows however, you find it's not as easy
                                to shout across</p>
                            <ul class="list-unstyled vstack gap-2 mb-0">
                                <li>
            ...
            <div class="collapse show" id="needsIdentified">
                <div class="card mb-1">
                    ...
                    <div class="collapse border-top border-top-dashed" id="needsIdentified1">
                        <div class="card-body">
                            <h6 class="fs-14 mb-1">Alexis Clarke <small
                                    class="badge badge-soft-danger">7 Days</small></h6>
                            <p class="text-muted">As a company grows however, you find it's not as easy
                                to shout across</p>
                            <ul class="list-unstyled vstack gap-2 mb-0">
                                <li>
                ...
                <div class="card mb-1">
                    ...
                    <div class="collapse border-top border-top-dashed" id="needsIdentified2">
                        <div class="card-body">
                            <h6 class="fs-14 mb-1">Meta4Systems <small
                                    class="badge badge-soft-warning">35 Days</small></h6>
                            <p class="text-muted">As a company grows however, you find it's not as easy
                                to shout across</p>
                            <ul class="list-unstyled vstack gap-2 mb-0">
                                <li>
                ...
                <div class="card mb-1">
                    ...
                    <div class="collapse border-top border-top-dashed" id="needsIdentified3">
                        <div class="card-body">
                            <h6 class="fs-14 mb-1">Syntyce Solutions <small
                                    class="badge badge-soft-danger">15 Days</small></h6>
                            <p class="text-muted">As a company grows however, you find it's not as easy
                                to shout across</p>
                            <ul class="list-unstyled vstack gap-2 mb-0">
                                <li>
                ...
                <div class="card mb-1 ribbon-box ribbon-fill ribbon-sm">
                    ...
                    <div class="card-body">
                        <a class="d-flex align-items-center" data-bs-toggle="collapse"
                            href="#needsIdentified4" role="button" aria-expanded="false"
                ...
                <div class="card mb-1">
                    <div class="card-body">
                        <a class="d-flex align-items-center" data-bs-toggle="collapse"
                            href="#needsIdentified6" role="button" aria-expanded="false"
                    ...
                    <div class="collapse border-top border-top-dashed" id="needsIdentified6">
                        <div class="card-body">
                            <h6 class="fs-14 mb-1">iTest Factory <small
                                    class="badge badge-soft-warning">42 Days</small></h6>
                            <p class="text-muted">As a company grows however, you find it's not as easy
                                to shout across</p>
                            <ul class="list-unstyled vstack gap-2 mb-0">
                                <li>
                ...
                <div class="card">
                    ...
                    <div class="collapse border-top border-top-dashed" id="needsIdentified7">
                        <div class="card-body">
                            <h6 class="fs-14 mb-1">Meta4Systems <small
                                    class="badge badge-soft-success">6 Month</small></h6>
                            <p class="text-muted">As a company grows however, you find it's not as easy
                                to shout across</p>
                            <ul class="list-unstyled vstack gap-2 mb-0">
                                <li>
            ...
            <div class="collapse show" id="meetingArranged">
                <div class="card mb-1">
                    ...
                    <div class="collapse border-top border-top-dashed" id="meetingArranged1">
                        <div class="card-body">
                            <h6 class="fs-14 mb-1">Nesta Technologies <small
                                    class="badge badge-soft-danger">10 Days</small></h6>
                            <p class="text-muted">As a company grows however, you find it's not as easy
                                to shout across</p>
                            <ul class="list-unstyled vstack gap-2 mb-0">
                                <li>
                ...
                <div class="card mb-1">
                    <div class="card-body">
                        <a class="d-flex align-items-center" data-bs-toggle="collapse"
                            ...
                            aria-controls="meetingArranged2">
                            <div class="flex-shrink-0">
                                <img src="{{ URL::asset('assets/images/users/avatar-3.jpg') }}" alt=""
                                    class="avatar-xs rounded-circle shadow" />
                            </div>
        ...
        <div class="col">
            ...
            <div class="collapse show" id="offerAccepted">
                ...
                <div class="card mb-1 ribbon-box ribbon-fill ribbon-sm">
                    ...
                    <div class="card-body">
                        <a class="d-flex align-items-center" data-bs-toggle="collapse"
                            href="#offerAccepted2" role="button" aria-expanded="false"
                    ...
                    <div class="collapse border-top border-top-dashed" id="offerAccepted2">
                        <div class="card-body">
                            <h6 class="fs-14 mb-1">Nesta Technologies <small
                                    class="badge badge-soft-warning">47 Days</small></h6>
                            <p class="text-muted">As a company grows however, you find it's not as easy
                                to shout across</p>
                            <ul class="list-unstyled vstack gap-2 mb-0">
                                <li>
                ...
                <div class="card mb-1">
                    ...
                    <div class="collapse border-top border-top-dashed" id="offerAccepted4">
                        <div class="card-body">
                            <h6 class="fs-14 mb-1">Nesta Technologies <small
                                    class="badge badge-soft-success">4 Month</small></h6>
                            <p class="text-muted">As a company grows however, you find it's not as easy
                                to shout across</p>
                            <ul class="list-unstyled vstack gap-2 mb-0">
                                <li>
                ...
                <div class="card mb-1 ribbon-box ribbon-fill ribbon-sm">
                    ...
                    <div class="card-body">
                        <a class="d-flex align-items-center" data-bs-toggle="collapse"
                            href="#offerAccepted5" role="button" aria-expanded="false"
                ...
                <div class="card mb-1 ribbon-box ribbon-fill ribbon-sm">
                    ...
                    <div class="card-body">
                        <a class="d-flex align-items-center" data-bs-toggle="collapse"
                            href="#offerAccepted6" role="button" aria-expanded="false"
                    ...
                    <div class="collapse border-top border-top-dashed" id="offerAccepted6">
                        <div class="card-body">
                            <h6 class="fs-14 mb-1">Nesta Technologies <small
                                    class="badge badge-soft-danger">14 Days</small></h6>
                            <p class="text-muted">As a company grows however, you find it's not as easy
                                to shout across</p>
                            <ul class="list-unstyled vstack gap-2 mb-0">
                                <li>
                ...
                <form>
                    <div class="modal-body">
                        <div class="mb-3">
                            ...
                            <input type="email" class="form-control" id="dealTitle"
                                placeholder="Enter title">
                        </div>
                        <div class="mb-3">
                            <label for="dealValue" class="form-label">Value (USD)</label>
                            <input type="text" class="form-control" id="dealValue"
                                placeholder="Enter value">
                        </div>
                        <div class="mb-3">
                            <label for="dealOwner" class="form-label">Deals Owner</label>
                            <input type="text" class="form-control" id="dealOwner"
