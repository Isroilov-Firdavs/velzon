    ...
    <div class="row">
        <div class="col-xxl-3 col-md-6">
            ...
            <div class="card mb-2">
                <div class="card-body">
                    <div class="d-flex mb-3">
                        ...
                        <div>
                            <a href="javascript:void(0);" class="badge badge-soft-primary">Visit Website
                ...
                <div class="card-body border-top border-top-dashed">
                    <div class="d-flex">
                        <div class="flex-grow-1">
                            <h6 class="mb-0">4.8 <i class="ri-star-fill align-bottom text-warning"></i>
                            </h6>
                        </div>
                        <h6 class="flex-shrink-0 text-danger mb-0"><i
                                class="ri-time-line align-bottom"></i> 05 Days</h6>
                    </div>
                </div>
            </div>
            <!--end card-->
            <div class="card mb-2">
                ...
                <div class="card-body border-top border-top-dashed">
                    <div class="d-flex">
                        <div class="flex-grow-1">
                            <h6 class="mb-0">4.4 <i class="ri-star-fill align-bottom text-warning"></i>
                            </h6>
                        </div>
                        <h6 class="flex-shrink-0 text-danger mb-0"><i
                                class="ri-time-line align-bottom"></i> 15 Days</h6>
                    </div>
                </div>
            </div>
            <!--end card-->
            <div class="card mb-2">
                ...
                <div class="card-body border-top border-top-dashed">
                    <div class="d-flex">
                        <div class="flex-grow-1">
                            <h6 class="mb-0">2.7 <i class="ri-star-fill align-bottom text-warning"></i>
                            </h6>
                        </div>
                        <h6 class="flex-shrink-0 text-warning mb-0"><i
                                class="ri-time-line align-bottom"></i> 25 Jan, 2022</h6>
                    </div>
                </div>
            </div>
            <!--end card-->
            <div class="card mb-2">
                ...
                <div class="card-body border-top border-top-dashed">
                    <div class="d-flex">
                        <div class="flex-grow-1">
                            <h6 class="mb-0">3.2 <i class="ri-star-fill align-bottom text-warning"></i>
                            </h6>
                        </div>
                        <h6 class="flex-shrink-0 text-warning mb-0"><i
                                class="ri-time-line align-bottom"></i> 04 Feb, 2022</h6>
                    </div>
                </div>
            </div>
            <!--end card-->
            <div class="card">
                ...
                <div class="card-body border-top border-top-dashed">
                    <div class="d-flex">
                        <div class="flex-grow-1">
                            <h6 class="mb-0">3.9 <i class="ri-star-fill align-bottom text-warning"></i>
                            </h6>
                        </div>
                        <h6 class="flex-shrink-0 text-warning mb-0"><i
                                class="ri-time-line align-bottom"></i> 05 March, 2022</h6>
                    </div>
                </div>
            </div>
            <!--end card-->
        ...
        <div class="col-xxl-3 col-md-6">
            ...
            <div class="card mb-2">
                ...
                <div class="card-body border-top border-top-dashed">
                    <div class="d-flex">
                        <div class="flex-grow-1">
                            <h6 class="mb-0">2.8 <i class="ri-star-fill align-bottom text-warning"></i>
                            </h6>
                        </div>
                        <h6 class="flex-shrink-0 text-muted mb-0"><i
                                class="ri-time-line align-bottom"></i> 02 Jan, 2022</h6>
                    </div>
                </div>
            </div>
            <!--end card-->
            <div class="card mb-2">
                ...
                <div class="card-body border-top border-top-dashed">
                    <div class="d-flex">
                        <div class="flex-grow-1">
                            <h6 class="mb-0">2.1 <i class="ri-star-fill align-bottom text-warning"></i>
                            </h6>
                        </div>
                        <h6 class="flex-shrink-0 text-muted mb-0"><i
                                class="ri-time-line align-bottom"></i> 23 Dec, 2021</h6>
                    </div>
                </div>
            </div>
            <!--end card-->
            <div class="card">
                ...
                <div class="card-body border-top border-top-dashed">
                    <div class="d-flex">
                        <div class="flex-grow-1">
                            <h6 class="mb-0">3.0 <i class="ri-star-fill align-bottom text-warning"></i>
                            </h6>
                        </div>
                        <h6 class="flex-shrink-0 text-muted mb-0"><i
                                class="ri-time-line align-bottom"></i> 04 Oct, 2021</h6>
                    </div>
                </div>
            </div>
            <!--end card-->
        ...
        <div class="col-xxl-3 col-md-6">
            ...
            <div class="card mb-2">
                ...
                <div class="card-body border-top border-top-dashed">
                    <div class="d-flex">
                        <div class="flex-grow-1">
                            <h6 class="mb-0">4.7 <i class="ri-star-fill align-bottom text-warning"></i>
                            </h6>
                        </div>
                        <h6 class="flex-shrink-0 text-primary mb-0"><i
                                class="ri-time-line align-bottom"></i> 15 Jan, 2022</h6>
                    </div>
                </div>
            </div>
            <!--end card-->
            <div class="card">
                ...
                <div class="card-body border-top border-top-dashed">
                    <div class="d-flex">
                        <div class="flex-grow-1">
                            <h6 class="mb-0">3.5 <i class="ri-star-fill align-bottom text-warning"></i>
                            </h6>
                        </div>
        ...
        <div class="col-xxl-3 col-md-6">
            ...
            <div class="card mb-2 ribbon-box ribbon-fill right">
                <div class="ribbon ribbon-info shadow-none"><i class="ri-flashlight-fill me-1"></i> 1
                </div>
                <div class="card-body">
                    <div class="d-flex mb-3">
                        <div class="flex-shrink-0 avatar-sm">
                ...
                <div class="card-body border-top border-top-dashed">
                    <div class="d-flex">
                        <div class="flex-grow-1">
                            <h6 class="mb-0">4.9 <i class="ri-star-fill align-bottom text-warning"></i>
                            </h6>
                        </div>
                        <h6 class="flex-shrink-0 text-warning mb-0"><i
                                class="ri-time-line align-bottom"></i> 16 Feb, 2022</h6>
                    </div>
                </div>
            </div>
            <!--end card-->
            <div class="card mb-2 ribbon-box ribbon-fill right">
                <div class="ribbon ribbon-info shadow-none"><i class="ri-flashlight-fill me-1"></i> 2
                </div>
                <div class="card-body">
                    <div class="d-flex mb-3">
                        <div class="flex-shrink-0 avatar-sm">
                ...
                <div class="card-body border-top border-top-dashed">
                    <div class="d-flex">
                        ...
                        <h6 class="flex-shrink-0 text-warning mb-0"><i
                                class="ri-time-line align-bottom"></i> 23 Jan, 2022</h6>
                    </div>
                </div>
            </div>
            <!--end card-->
            <div class="card mb-2 ribbon-box ribbon-fill right">
                <div class="ribbon ribbon-info shadow-none"><i class="ri-flashlight-fill me-1"></i> 3
                </div>
                <div class="card-body">
                    <div class="d-flex mb-3">
                        <div class="flex-shrink-0 avatar-sm">
                ...
                <div class="card-body border-top border-top-dashed">
                    <div class="d-flex">
                        ...
                        <h6 class="flex-shrink-0 text-warning mb-0"><i
                                class="ri-time-line align-bottom"></i> 30 Dec, 2021</h6>
                    </div>
                </div>
            </div>
            <!--end card-->
            <div class="card ribbon-box ribbon-fill right">
                <div class="ribbon ribbon-info shadow-none"><i class="ri-flashlight-fill me-1"></i> 4
                </div>
                <div class="card-body">
                    <div class="d-flex mb-3">
                        <div class="flex-shrink-0 avatar-sm">
                ...
                <div class="card-body border-top border-top-dashed">
                    <div class="d-flex">
                        ...
                        <h6 class="flex-shrink-0 text-warning mb-0"><i
                                class="ri-time-line align-bottom"></i> 02 Dec, 2021</h6>
                    </div>
                </div>
            </div>
            <!--end card-->
