                ...
                <ul class="list-unstyled vstack gap-3 mb-0">
                    <li>
                        <div class="d-flex align-items-center">
                            <div class="flex-shrink-0">
                                <img src="{{ URL::asset('assets/images/users/avatar-10.jpg') }}" alt="" class="avatar-xs rounded-circle shadow">
                            </div>
                            <div class="flex-grow-1 ms-2">
                                <h6 class="mb-1"><a href="pages-profile" class="text-body">Tonya Noble</a></h6>
                    ...
                    <li>
                        <div class="d-flex align-items-center">
                            <div class="flex-shrink-0">
                                <img src="{{ URL::asset('assets/images/users/avatar-8.jpg') }}" alt="" class="avatar-xs rounded-circle shadow">
                            </div>
                            <div class="flex-grow-1 ms-2">
                                <h6 class="mb-1"><a href="pages-profile" class="text-body">Thomas Taylor</a></h6>
                    ...
                    <li>
                        <div class="d-flex align-items-center">
                            <div class="flex-shrink-0">
                                <img src="{{ URL::asset('assets/images/users/avatar-2.jpg') }}" alt="" class="avatar-xs rounded-circle shadow">
                            </div>
                            <div class="flex-grow-1 ms-2">
                                <h6 class="mb-1"><a href="pages-profile" class="text-body">Nancy Martino</a></h6>
                    ...
                    <div class="tab-pane active" id="home-1" role="tabpanel">
                        ...
                        <div data-simplebar style="height: 508px;" class="px-3 mx-n3 mb-2">
                            <div class="d-flex mb-4">
                                <div class="flex-shrink-0">
                                    <img src="{{ URL::asset('assets/images/users/avatar-7.jpg') }}" alt="" class="avatar-xs rounded-circle shadow" />
                                </div>
                                <div class="flex-grow-1 ms-3">
                                    <h5 class="fs-13"><a href="pages-profile" class="text-body">Joseph Parker</a> <small class="text-muted">20 Dec 2021 - 05:47AM</small></h5>
                                    ...
                                    <div class="d-flex mt-4">
                                        ...
                                        <div class="flex-grow-1 ms-3">
                                            <h5 class="fs-13"><a href="pages-profile" class="text-body">Tonya Noble</a> <small class="text-muted">22 Dec 2021 - 02:32PM</small></h5>
                            ...
                            <div class="d-flex mb-4">
                                ...
                                <div class="flex-grow-1 ms-3">
                                    <h5 class="fs-13"><a href="pages-profile" class="text-body">Thomas Taylor</a> <small class="text-muted">24 Dec 2021 - 05:20PM</small></h5>
                            ...
                            <div class="d-flex">
                                ...
                                <div class="flex-grow-1 ms-3">
                                    <h5 class="fs-13"><a href="pages-profile" class="text-body">Tonya Noble</a> <small class="text-muted">26 min ago</small></h5>
                                    ...
                                    <div class="d-flex mt-4">
                                        <div class="flex-shrink-0">
                                            <img src="{{ URL::asset('assets/images/users/avatar-6.jpg') }}" alt="" class="avatar-xs rounded-circle shadow" />
                                        </div>
                                        <div class="flex-grow-1 ms-3">
                                            <h5 class="fs-13"><a href="pages-profile" class="text-body">Nancy Martino</a> <small class="text-muted">8 sec ago</small></h5>
                                    ...
                                    <tr>
                                        <th scope="row">
                                            <div class="d-flex align-items-center">
                                                ...
                                                <div class="flex-grow-1 ms-2">
                                                    <a href="pages-profile" class="fw-medium text-body">Thomas Taylor</a>
                                                </div>
                                            </div>
                                        </th>
                                        <td>02 Jan, 2022</td>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="d-flex align-items-center">
                                                ...
                                                <div class="flex-grow-1 ms-2">
                                                    <a href="pages-profile" class="fw-medium text-body">Tonya Noble</a>
                                                </div>
                                            </div>
                                        </td>
                                        <td>28 Dec, 2021</td>
