    ...
    <div class="row">
        <div class="col-xl-12">
            <div class="card">
                ...
                <div class="card-body">
                    <p class="text-muted">Add nearly any within, even for linked list groups like the one below, with the help of <a href="https://getbootstrap.com/docs/5.1/utilities/flex/">flexbox utilities</a>.</p>
                    <div class="live-preview">
                        <div class="list-group">
...
&lt;/ol&gt;</code></pre>
        ...
        <div class="col-xxl-4 col-xl-6">
            <div class="card">
                ...
                <div class="card-body">
                    <p>Add nearly any within, even for linked list groups like the one below, with the help of <a href="https://getbootstrap.com/docs/5.1/utilities/flex/">flexbox utilities</a>.</p>                           <div class="live-preview">
