    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="card">
                ...
                <div class="card-body">
                    <p class="text-muted">Use the <code>alert-additional</code> class and Use the <code>alert-</code> class to elements like headings, paragraphs, dividers etc.</p>
                    <div class="live-preview">
                        <div class="row">
                            <div class="col-xl-6">
                                <h6>Primary Alert</h6>
...
@endsection
@section('script')
    <script src="assets/libs/prismjs/prismjs.min.js"></script>
    ...
    <script>
        ...
        function alert(message, type) {
            ...
            wrapper.inne = '<div class="alert alert-' + type + ' alert-dismissible" role="alert">' + message +
