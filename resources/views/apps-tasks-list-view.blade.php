                        ...
                        <table class="table align-middle table-nowrap mb-0" id="tasksTable">
                            ...
                            <tbody class="list form-check-all">
                                ...
                                <tr >
                                    ...
                                    <td class="id"><a href="apps-tasks-details" class="fw-medium link-primary">#VLZ453</a></td>
                                    <td class="project_name"><a href="apps-projects-overview" class="fw-medium link-primary">Skote - v1.0.0</a></td>
                                    <td>
                                        <div class="d-flex">
                                    ...
                                    <td class="assignedto">
                                        <div class="avatar-group">
                                            ...
                                            <a href="javascript: void(0);" class="avatar-group-item shadow" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-placement="top" title="Donald">
                                ...
                                <tr >
                                    ...
                                    <td class="id"><a href="apps-tasks-details" class="fw-medium link-primary">#VLZ454</a></td>
                                    <td class="project_name"><a href="apps-projects-overview" class="fw-medium link-primary">Skote - v2.3.0</a></td>
                                    <td>
                                        <div class="d-flex">
                                    ...
                                    <td class="assignedto">
                                        <div class="avatar-group">
                                            ...
                                            <a href="javascript: void(0);" class="avatar-group-item shadow" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-placement="top" title="Alexis">
                                                <img src="{{ URL::asset('assets/images/users/avatar-6.jpg') }}" alt="" class="rounded-circle avatar-xxs" />
                                            </a>
                                            <a href="javascript: void(0);" class="avatar-group-item shadow" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-placement="top" title="Michael">
                                ...
                                <tr >
                                    ...
                                    <td class="id"><a href="apps-tasks-details" class="fw-medium link-primary">#VLZ455</a></td>
                                    <td class="project_name"><a href="apps-projects-overview" class="fw-medium link-primary">Minia - v1.4.0</a></td>
                                    <td>
                                        <div class="d-flex">
                                ...
                                <tr >
                                    ...
                                    <td class="id"><a href="apps-tasks-details" class="fw-medium link-primary">#VLZ456</a></td>
                                    <td class="project_name"><a href="apps-projects-overview" class="fw-medium link-primary">Minia - v1.2.0</a></td>
                                    <td>
                                        <div class="d-flex">
                                ...
                                <tr >
                                    ...
                                    <td class="id"><a href="apps-tasks-details" class="fw-medium link-primary">#VLZ457</a></td>
                                    <td class="project_name"><a href="apps-projects-overview" class="fw-medium link-primary">Minimal - v2.1.0</a></td>
                                    <td>
                                        <div class="d-flex">
                                ...
                                <tr>
                                    ...
                                    <td class="id"><a href="apps-tasks-details" class="fw-medium link-primary">#VLZ458</a></td>
                                    <td class="project_name"><a href="apps-projects-overview" class="fw-medium link-primary">Dason - v1.1.0</a></td>
                                    <td>
                                        <div class="d-flex">
                                ...
                                <tr>
                                    ...
                                    <td class="id"><a href="apps-tasks-details" class="fw-medium link-primary">#VLZ459</a></td>
                                    <td class="project_name"><a href="apps-projects-overview" class="fw-medium link-primary">Dorsin - Landing Page</a></td>
                                    <td>
                                        <div class="d-flex">
                                    ...
                                    <td class="assignedto">
                                        <div class="avatar-group">
                                            ...
                                            <a href="javascript: void(0);" class="avatar-group-item shadow" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-placement="top" title="Jennifer">
                                ...
                                <tr>
                                    ...
                                    <td class="id"><a href="apps-tasks-details" class="fw-medium link-primary">#VLZ460</a></td>
                                    <td class="project_name"><a href="apps-projects-overview" class="fw-medium link-primary">Qexal - Landing Page</a></td>
                                    <td>
                                        <div class="d-flex">
                                ...
                                <tr>
                                    ...
                                    <td class="id"><a href="apps-tasks-details" class="fw-medium link-primary">#VLZ461</a></td>
                                    <td class="project_name"><a href="apps-projects-overview" class="fw-medium link-primary">Doot - Chat App Template</a></td>
                                    <td>
                                        <div class="d-flex">
                                ...
                                <tr>
                                    ...
                                    <td class="id"><a href="apps-tasks-details" class="fw-medium link-primary">#VLZ462</a></td>
                                    <td class="project_name"><a href="apps-projects-overview" class="fw-medium link-primary">Skote - v2.1.0</a></td>
                                    <td>
                                        <div class="d-flex">
                    ...
                    <div class="modal-body">
                        <div class="row g-3">
                            ...
                            <div class="col-lg-12">
                                ...
                                <input type="text" id="createName-field" class="form-control" placeholder="Client name" required />
                            </div><!--end col-->
                            <div class="col-lg-12">
