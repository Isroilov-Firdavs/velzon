            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="d-flex align-middle">
                        <div class="flex-shrink-0">
                            <img src="{{ URL::asset('assets/images/small/img-1.jpg') }}" class="rounded img-fluid shadow"
                    ...
                    <div class="d-flex mt-4">
                        <div class="flex-shrink-0">
                            <img src="{{ URL::asset('assets/images/small/img-2.jpg') }}" class="rounded img-fluid shadow"
                                style="height: 60px;" alt="">
                        </div>
                        <div class="flex-grow-1 ms-3">
                    ...
                    <div class="d-flex mt-4">
                        <div class="flex-shrink-0">
                            <img src="{{ URL::asset('assets/images/small/img-3.jpg') }}" class="rounded img-fluid shadow"
                                style="height: 60px;" alt="">
                        </div>
                        <div class="flex-grow-1 ms-3">
                    ...
                    <div class="d-flex mt-4">
                        <div class="flex-shrink-0">
                            <img src="{{ URL::asset('assets/images/small/img-6.jpg') }}" class="rounded img-fluid shadow"
                                style="height: 60px;" alt="">
                        </div>
                        <div class="flex-grow-1 ms-3">
