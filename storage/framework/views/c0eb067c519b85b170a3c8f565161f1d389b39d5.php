                        ...
                        <div class="card-body">
                            <div class="d-flex mb-2">
                                <h6 class="fs-15 mb-0 flex-grow-1 text-truncate"><a
                                        href="apps-tasks-details" class="text-body">Profile Page
                                        Structure</a></h6>
                                <div class="dropdown">
                            ...
                            <div class="d-flex mb-2">
                                <div class="flex-grow-1">
                                    <h6 class="fs-15 mb-0 text-truncate"><a
                                            href="apps-tasks-details" class="text-body">Velzon -
                    ...
                    <div class="card tasks-box">
                        <div class="card-body">
                            <div class="d-flex mb-2">
                                <div class="flex-grow-1">
                                    <h6 class="fs-15 mb-0 text-truncate"><a
                                            href="apps-tasks-details" class="text-body">Admin
                                            Layout Design</a></h6>
                                </div>
                                <div class="flex-shrink-0">
                                    <a href="javascript:void(0);" class="text-muted"
                    ...
                    <div class="card tasks-box">
                        <div class="card-body">
                            <div class="d-flex mb-2">
                                <div class="flex-grow-1">
                                    <h6 class="fs-15 mb-0 text-truncate"><a
                                            href="apps-tasks-details" class="text-body">Marketing &
                                            Sales</a></h6>
                                </div>
                                <div class="flex-shrink-0">
                                    <a href="javascript:void(0);" class="text-muted"
                ...
                <div id="inprogress-task" class="tasks">
                    <div class="card tasks-box">
                        <div class="card-body">
                            ...
                            <h6 class="fs-15 text-truncate"><a href="apps-tasks-details"
                                    class="text-body">Brand Logo Design</a></h6>
                    ...
                    <div class="card tasks-box">
                        <div class="card-body">
                            ...
                            <h6 class="fs-15 text-truncate"><a href="apps-tasks-details"
                                    class="text-body">Change Old App Icon</a></h6>
                ...
                <div id="reviews-task" class="tasks">
                    <div class="card tasks-box">
                        <div class="card-body">
                            ...
                            <h6 class="fs-15 text-truncate"><a href="apps-tasks-details"
                                    class="text-body">Create Product Animations</a></h6>
                    ...
                    <div class="card tasks-box">
                        <div class="card-body">
                            ...
                            <h6 class="fs-15 text-truncate"><a href="apps-tasks-details"
                                    class="text-body">Product Features Analysis</a></h6>
                    ...
                    <div class="card tasks-box">
                        <div class="card-body">
                            ...
                            <h6 class="fs-15 text-truncate"><a href="apps-tasks-details"
                                    class="text-body">Create a Graph of Sketch</a></h6>
                ...
                <div id="completed-task" class="tasks">
                    <div class="card tasks-box">
                        <div class="card-body">
                            <div class="d-flex mb-2">
                                <h6 class="fs-15 mb-0 flex-grow-1 text-truncate"><a
                                        href="apps-tasks-details" class="text-body">Create a Blog
                                        Template UI</a></h6>
                                <div class="dropdown">
                                    <a href="javascript:void(0);" class="text-muted"
                ...
                <div id="new-task" class="tasks">
                    <div class="card tasks-box">
                        <div class="card-body">
                            ...
                            <h6 class="fs-15 text-truncate"><a href="apps-tasks-details"
                                    class="text-body">Banner Design for FB & Twitter</a></h6>
                            <div class="tasks-img rounded"
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/macbookpro/Desktop/laravel_dashboard/velzon/Velzon_Laravel_v1.3.0/material/resources/views/apps-tasks-kanban.blade.php ENDPATH**/ ?>