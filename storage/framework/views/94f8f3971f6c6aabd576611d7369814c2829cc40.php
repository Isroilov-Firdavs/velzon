                                ...
                                <div class="d-block dropdown-item text-wrap px-3 py-2">
                                    <div class="d-flex align-items-center">
                                        <img src="<?php echo e(URL::asset('assets/images/products/img-1.png')); ?>"
                                            class="me-3 rounded-circle avatar-sm p-2 bg-light shadow" alt="user-pic">
                                        <div class="flex-1">
                                        ...
                                        <div class="ps-2">
                                            <button type="button" class="btn btn-icon btn-sm btn-ghost-secondary shadow-none"><i
                                ...
                                <div class="d-block dropdown-item text-wrap px-3 py-2">
                                    <div class="d-flex align-items-center">
                                        <img src="<?php echo e(URL::asset('assets/images/products/img-3.png')); ?>"
                                            class="me-3 rounded-circle avatar-sm p-2 bg-light shadow-none" alt="user-pic">
                                        <div class="flex-1">
                                            <h6 class="mt-0 mb-1 fs-14">
                                ...
                                <div data-simplebar style="max-height: 300px;" class="pe-2">
                                    <div class="text-reset notification-item d-block dropdown-item position-relative">
                                        <div class="d-flex">
                                            <div class="avatar-xs me-3">
                                                <span class="avatar-title bg-soft-info text-info rounded-circle shadow fs-16">
                                    ...
                                    <div class="text-reset notification-item d-block dropdown-item position-relative">
                                        <div class="d-flex">
                                            <img src="<?php echo e(URL::asset('assets/images/users/avatar-2.jpg')); ?>"
                                                class="me-3 rounded-circle avatar-xs shadow" alt="user-pic">
                                            <div class="flex-1">
                                    ...
                                    <div class="text-reset notification-item d-block dropdown-item position-relative">
                                        <div class="d-flex">
                                            <div class="avatar-xs me-3">
                                                <span
                                                    class="avatar-title bg-soft-danger text-danger rounded-circle shadow fs-16">
                                    ...
                                    <div class="text-reset notification-item d-block dropdown-item position-relative">
                                        <div class="d-flex">
                                            <img src="<?php echo e(URL::asset('assets/images/users/avatar-8.jpg')); ?>" class="me-3 rounded-circle avatar-xs shadow" alt="user-pic">
                                            <div class="flex-1">
                                    ...
                                    <div class="my-3 text-center">
                                        <button type="button" class="btn btn-soft-success waves-effect waves-light shadow-none">View
...
<?php /**PATH /Users/macbookpro/Desktop/laravel_dashboard/velzon/Velzon_Laravel_v1.3.0/material/resources/views/layouts/topbar.blade.php ENDPATH**/ ?>